...
Part 1 and part 2 solutions are in separate folders (e.g., `src/days/01/part-1/`, `src/days/01/part-2/`).

## Solving

Use `/solve-day` or `/solve-part` commands. Create example1.txt/example2.txt from the problem's examples.
